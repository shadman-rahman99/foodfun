...
<body>
    ...
    <section class="table-area section-padding">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1><b>Discover</b> what other customers <br> have to say after dining here.</h1>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <div class="section-top">
                        <p class="pt-3">This is what customers say. We did not put words into their mouths. Only food.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6">
                    <div class="single-food">
                        <div class="food-img">
                        <?php echo "<img src='assets/images/".$row['image']."' height='150' width='130' alt=''>"; ?>
                        </div>
