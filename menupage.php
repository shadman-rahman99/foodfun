    ...
    <section class="banner-area banner-area2 menu-bg text-center">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1><i>Our Menu</i></h1>
                    <p class="pt-2"><i>Where your culinary dreams come true.</i></p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="section-top">
                        <p class="pt-3">This is what we have on the menu. But don't be mistaken. If we have the ingredients and you want us to <b>make</b> something, it can be arranged.</p>
                    </div>
                </div>
            </div>
